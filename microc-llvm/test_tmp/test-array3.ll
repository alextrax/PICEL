...
entry:
  %a = alloca [3 x i32]
  %c_ptr = bitcast [3 x i32]* %a to i32*
  %elmt_addr = getelementptr inbounds i32* %c_ptr, i32 0
  store i32 0, i32* %elmt_addr
  %c_ptr1 = bitcast [3 x i32]* %a to i32*
  %elmt_addr2 = getelementptr inbounds i32* %c_ptr1, i32 1
  store i32 1, i32* %elmt_addr2
  %c_ptr3 = bitcast [3 x i32]* %a to i32*
  %elmt_addr4 = getelementptr inbounds i32* %c_ptr3, i32 2
  store i32 2, i32* %elmt_addr4
  %c_ptr5 = bitcast [3 x i32]* %a to i32*
  %elmt_addr6 = getelementptr inbounds i32* %c_ptr5, i32 0
  %elmt = load i32* %elmt_addr6
  %printf = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @fmti, i32 0, i32 0), i32 %elmt)
  %c_ptr7 = bitcast [3 x i32]* %a to i32*
  %elmt_addr8 = getelementptr inbounds i32* %c_ptr7, i32 0
  store i32 3, i32* %elmt_addr8
  %c_ptr9 = bitcast [3 x i32]* %a to i32*
  %elmt_addr10 = getelementptr inbounds i32* %c_ptr9, i32 0
  %elmt11 = load i32* %elmt_addr10
  %printf12 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @fmti, i32 0, i32 0), i32 %elmt11)
  ret i32 0
}
