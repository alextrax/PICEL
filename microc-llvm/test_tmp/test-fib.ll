...
entry:
  ...
  %printf = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @fmti, i32 0, i32 0), i32 %fib_result)
  %fib_result1 = call i32 @fib(i32 1)
  %printf2 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @fmti, i32 0, i32 0), i32 %fib_result1)
  %fib_result3 = call i32 @fib(i32 2)
  %printf4 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @fmti, i32 0, i32 0), i32 %fib_result3)
  %fib_result5 = call i32 @fib(i32 3)
  %printf6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @fmti, i32 0, i32 0), i32 %fib_result5)
  %fib_result7 = call i32 @fib(i32 4)
  %printf8 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @fmti, i32 0, i32 0), i32 %fib_result7)
  %fib_result9 = call i32 @fib(i32 5)
  %printf10 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @fmti, i32 0, i32 0), i32 %fib_result9)
  ret i32 0
}
